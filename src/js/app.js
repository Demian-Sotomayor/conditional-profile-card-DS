...
function render(variables = {}) {
  ...
  if (variables.role === null) variables.role = "Rol";
  if (variables.country === null) variables.country = "País";
  if (variables.city === null) variables.city = "Ciudad";
  if (variables.socialMediaPosition === null)
    variables.socialMediaPosition = "Left";
  if (variables.twitter === null) variables.twitter = "Username";
  if (variables.github === null) variables.github = "Username";
  if (variables.linkedin === null) variables.linkedin = "Username";
  if (variables.instagram === null) variables.instagram = "Username";
